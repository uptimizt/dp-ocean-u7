...
<div id="post-<?php the_ID(); ?>" <?php post_class( ); ?>>
	...
	<div class="rating-entry-row">
			...
			<div class="item-meta">
				...
				<?php if($product->get_average_rating()): ?>
					<div class="rating-block">
						...
						<span><?= $product->get_rating_html($product->get_average_rating())  ?></span>
		...
		<div class="item-actions">
			...
			<div class="readmore wp-block-button aligncenter">
				<a href="<?= $product->get_permalink() ?>" class="wp-block-button__link" rel="noopener noreferrer">Обзор</a>
			</div>

			<div class="site-link wp-block-button aligncenter">
